<?php \Classes\ClassLayout::setHead('LOGIN FUNCIONAIO', 'Area apenas para login de funcionários.'); ?>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">LOGIN FUNCIONÁRIO</h1>
                  </div>
                  
                    <form class ="user" name="formLogin" id="formLogin" action="<?php echo DIRPAGE . 'controller/controllerLogin'; ?>" method="post">

                        <input type="hidden" class="form-control" name="acao" id="acao" value="loginFuncionario">
                  ...
                  <div class="text-center">
                      <a class="small" href="login">login lojista</a>
                  </div>
                </div>
              </div>
            </div>
