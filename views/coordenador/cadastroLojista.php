...
?>
    ...
    <div class="card col-10">
            ...
            <h5 class="card-header">Cadastro lojista</h5>

            <div id="solicita" name="solicita" class="card-body col">
                <h5 class="card-title">Dados do lojista</h5>

                <form name="formCadastro" id="formCadastro" action="<?php echo DIRPAGE . 'controller/controllerSolicitarAcesso'; ?>" method="post">
                   
                        <input type="hidden" class="form-control" name="acao" id="acao" value="solicitaAcesso">
                        <input type="hidden" class="form-control" name="status" id="status" value="ativo">
